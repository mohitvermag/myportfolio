                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-12">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                            ...
                            <a href="#" className="px-8 py-3 border border-slate-700 text-gray-300 rounded-full font-semibold hover:border-cyan-500 hover:text-cyan-400 transition-all flex items-center justify-center">
                    ...
                    >
                        <div className="relative w-72 h-72 md:w-96 md:h-96 mx-auto">
                            ...
                            <div className="relative w-full h-full rounded-full border-4 border-slate-800 bg-slate-900 overflow-hidden shadow-2xl">
                                ...
                                <div className="w-full h-full flex items-center justify-center bg-slate-800 text-slate-600 text-6xl font-bold">
                                    MV
                                </div>
                            </div>
                        </div>
